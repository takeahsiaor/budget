...
urlpatterns = patterns('',
    ...
    url(r'^business-related-overview/$', views.BusinessExpenseOverview.as_view(),
        name='business_related_overview'),
    ...
    url(r'^business-transactions/$',
        views.get_business_expense_transactions, name='get_business_transactions'),
